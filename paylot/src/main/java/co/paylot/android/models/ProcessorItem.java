...
public class ProcessorItem extends HashedTxData {
    ...
    private TxSubAccount subAccount;
    ...
    public String getAmountData() {
        return String.format("%s %s",
                getAmount(), currencyData.getSymbol());
    }
    ...
    public TxSubAccount getSubAccount() {
        return subAccount;
    }
    ...
    private class TxSubAccount {
        private String id;
        private double amount;

        public TxSubAccount(String id, double amount) {
            this.id = id;
            this.amount = amount;
        }
    }
