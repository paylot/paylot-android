...
public class ProcessorAdapter extends RecyclerView.Adapter<ProcessorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.cardBody.setCardBackgroundColor(getColor(item.isSelected() ? R.color.skyBlue : R.color.white));
        ...
        holder.nameText.setTextColor(getColor(item.isSelected() ? R.color.white : R.color.black));
        holder.valueText.setTextColor(getColor(item.isSelected() ? R.color.white : R.color.black));
    }
